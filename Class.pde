 class imageToSound {
  ...
  // costruttore
  imageToSound(Capture src, PImage prev, float _threshold,int _screenWidth,int _screenHeight) {
 ...
 ---------------------------------------------*/
  ...
  void scanImage(Capture src, PImage prev, float threshold) {
 ...
 /*
   Classe static per metodi utility
*/

 static class utils {
   
   /*
   questo metodo calcola la rispettiva frequanza di una nota midi
   */
